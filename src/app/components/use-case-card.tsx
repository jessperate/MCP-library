...
function SEOIllustration({ accent }: { accent: string }) {
  return (
    ...
    >
      ...
      {/* Upward trend line */}
      <polyline
        points="49,90 77,70 105,50 133,55 161,70"
        stroke="#002910"
        strokeWidth="1.5"
        strokeOpacity="0.25"
        strokeDasharray="4 3"
...
function SalesIllustration({ accent }: { accent: string }) {
  return (
    ...
    >
      ...
      {/* Arrow connectors */}
      <path d="M 86 80 L 104 80" stroke="#002910" strokeWidth="1.5" strokeOpacity="0.2" markerEnd="url(#arr1)" />
...
function SupportIllustration({ accent }: { accent: string }) {
  return (
    ...
    >
      ...
      {/* Response lines in second bubble */}
...
function DataIllustration({ accent }: { accent: string }) {
  return (
    ...
    >
      ...
      <path
        d="M 30 120 L 60 100 L 90 108 L 120 72 L 150 60 L 180 68 L 210 44 L 240 50 L 270 38 L 290 42 L 290 130 L 30 130 Z"
        fill={accent}
        opacity="0.35"
      />
      <path
        d="M 30 120 L 60 100 L 90 108 L 120 72 L 150 60 L 180 68 L 210 44 L 240 50 L 270 38 L 290 42"
        stroke="#002910"
        strokeWidth="2"
        strokeOpacity="0.3"
        fill="none"
...
function CardIllustration({
  ...
  switch (category) {
    case "SEO & Content":
      return <SEOIllustration accent={accent} />;
    case "Sales & CRM":
      return <SalesIllustration accent={accent} />;
    case "Engineering":
      return <EngineeringIllustration accent={accent} />;
    case "Marketing":
      return <MarketingIllustration accent={accent} />;
    case "Support":
      return <SupportIllustration accent={accent} />;
    case "Data & Analytics":
      return <DataIllustration accent={accent} />;
    default:
      return <DataIllustration accent={accent} />;
  }
}
